...
> **Phase B is fully shipped.** Math layer (5 formats, override engine, 133 unit tests, 4 snapshots), database foundation (B4.1–B4.5 ✅), format gate (B1.1–B1.6 ✅), and override / scoring-basis admin UI (B3.1–B3.3 ✅). Phase C status tracked in its own section below.
