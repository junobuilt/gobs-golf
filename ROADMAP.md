...
*Last updated: May 10, 2026 — admin format/team-build flow pivot shipped to master alongside TD4 fix; Phase A.1 PR 1 (A1.1–A1.5, TD7/TD10/TD11/TD13) merged earlier the same day; LT2 not reproducible across 3 triage variants 2026-05-10, A1.6/A1.7 unblocked.*
...
| I13 | Admin UI: edit `players.preferred_tee_id` from Players tab | 📋 | Per-player tee preference column shipped 2026-05-10 (migration `004_phase_a_preferred_tee.sql`, default White/Yellow Combo / id=4, Wayne Vincent seeded to White / id=2). Admin tab needs a tee dropdown on each player row to add/edit/clear `preferred_tee_id`. Until shipped, new exceptions require a direct SQL update. |
