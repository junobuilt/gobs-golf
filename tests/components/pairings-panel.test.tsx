...
function session(format: "greensomes" | "four_ball_match" | "singles_match"): TournamentSession {
  return { id: 9, tournament_id: 1, round_id: 50, day_number: 1, name: "Day 1 — Test", format, played_on: "2026-08-01", is_locked: false, is_voided: false, handicap_allowance: null };
}
